...
from pmx.scripts.workflows.SGE_tasks.absFE.LinP.Workflow_alligned_in_Protein import SGE_Workflow_alligned_in_Protein, my_WorkerSchedulerFactory, SGE_test

# ==============================================================================
#                             Workflow Class
# ==============================================================================
class SGE_Workflow_in_Water(SGE_Workflow_alligned_in_Protein):

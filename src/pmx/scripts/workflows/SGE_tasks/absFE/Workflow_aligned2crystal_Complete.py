...
from pmx.scripts.workflows.SGE_tasks.absFE.summary import Task_summary_aligned2crystal

# ==============================================================================
#                             Workflow Class
# ==============================================================================
class SGE_Workflow_aligned2crystal_complete(SGE_Workflow):
...
def main(args):
    ...
    w=SGE_Workflow_aligned2crystal_complete(

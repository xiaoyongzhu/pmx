...
# raw gaff data
my $ligsRef = get_ligands("/home/vgapsys/project/janssen/schroedinger_set/$case/top_gaff2_am1bcc_sigmahole");
my @ligs = @$ligsRef;
#print "@ligs\n";

system("mkdir $base/$case/ligands_gaff2");
copy_gaff(\@ligs,"$base/$case/ligands_gaff2","/home/vgapsys/project/janssen/schroedinger_set/$case/top_gaff2_am1bcc_sigmahole");

system("mkdir $base/$case/ligands_cgenff");
copy_cgenff(\@ligs,"$base/$case/ligands_cgenff","/home/vgapsys/project/janssen/schroedinger_set/$case/top_cgenff_match_sigmahole");
...
copy_transformations("$base/$case/transformations_gaff2","/home/vgapsys/project/janssen/schroedinger_set/$case/sim_gaff2_am1bcc_sigmahole_scaleMass/water");
...
copy_transformations("$base/$case/transformations_cgenff","/home/vgapsys/project/janssen/schroedinger_set/$case/sim_cgenff_sigmahole_scaleMass/water");

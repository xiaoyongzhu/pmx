...
copy_cgenff(\@ligs,"$base/$case/ligands_cgenff","/home/vgapsys/project/janssen/schroedinger_set/$case/top_paramchem_sigmahole");
...
copy_transformations("$base/$case/transformations_cgenff","/home/vgapsys/project/janssen/schroedinger_set/$case/sim_paramchem_sigmahole/water");

...
system("cp $protPath/protein/amber_cys/*itp $base/$case/protein_amber/.");
system("cp $protPath/protein/amber_cys/protein.pdb $base/$case/protein_amber/.");
...
system("cp $protPath/protein/charmm_cys/*itp $base/$case/protein_charmm/.");
system("cp $protPath/protein/charmm_cys/protein.pdb $base/$case/protein_charmm/.");

...
system("cp $protPath/protein/amber/prot.pdb $base/$case/protein_amber/protein.pdb");
...
system("cp $protPath/protein/charmm/prot.pdb $base/$case/protein_charmm/protein.pdb");
...
copy_transformations("$base/$case/transformations_gaff2","/home/vgapsys/project/janssen/schroedinger_set/$case/sim_gaff2_sigmahole/test_water");
...
copy_transformations("$base/$case/transformations_cgenff","/home/vgapsys/project/janssen/schroedinger_set/$case/sim_cgenff_sigmahole/test_water");
